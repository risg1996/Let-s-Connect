...
<link rel="stylesheet" type="text/css" href="css/newgroup.css"></link>
	...
	if(format.test(data)==true)
	 {
		...
		document.getElementById('flag1').innerHTML="Length of input should be less than 20 characters";
	else
...
<body onLoad="exist()" style="background-image:url('images/b.jpg');background-size:cover;">
   ...
   <div id="header">
    ...
    <div id="about">
    <h4>Instructions</h4>
	<p>&#x261B; &nbsp; <i>A group's name and a username can not have more than 20 and special characters(only alphabets,numbers and underscore are alloowed).</i> </p>
	<p>&#x261B; &nbsp; <i>Please create unique group names and tell only to those whom you want to be added to the group.</i></p>
	<p>&#x261B; &nbsp; <i>If you already have a username and password and want this group to be shown in your account than use that username and password
	                      otherwise new username and password will be created along with this group.</i></p>
	<p>&#x261B; &nbsp; <i>Creator of the group will become the admin of the group and only he/she can delete the group whenever he/she want.</i></p>			
     </div>
    <div id="right">
	
	<form action="validation_ng.php" method="get" onSubmit="return checker()">
    <table id="table">
    <tr>
